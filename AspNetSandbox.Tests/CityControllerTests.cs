...
namespace AspNetSandbox.Tests
{
    public class CityControllerTests
    {
        ...
        public void CityControllerTestBrasov()
        {
            ...
            var controller = new WeatherForecastCityCoordController();

            // Act
            var output = controller.ConvertCityCoordResponseToWeatherForecast(content,"Brasov");
        ...
        public void CityControllerTestLondon()
        {
            ...
            //Act
            var output = controller.ConvertCityCoordResponseToWeatherForecast(content,"London");
        ...
        public void CityControllerTestBerlin()
        {
            ...
            //Act
            var output = controller.ConvertCityCoordResponseToWeatherForecast(content,"Berlin");
